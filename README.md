...
|AI-Powered Recipe Recommender App|[It's a tool developed to to develop an intelligent web application that helps users discover recipes tailored to their individual preferences](https://github.com/akthammomani/AI_Powered_Recipe_Recommender) [![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_red.svg)](https://ai-powered-recipe-recommender.streamlit.app/)|  
